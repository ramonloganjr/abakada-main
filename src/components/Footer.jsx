          ...
          <div className="footer-content">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://github.com/ramonloganjr/abakada-main/" target="_blank" rel="noopener noreferrer" className="footer-social__link" aria-label="GitHub">
            ...
            <div className="footer-section">
              ...
              <nav className="footer-links">
                ...
                <a href="https://github.com/ramonloganjr/abakada-main/" target="_blank" rel="noopener" className="footer-link">{t('footer.contribute', 'Contribute on GitHub')}</a>
